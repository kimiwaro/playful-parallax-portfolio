  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Interactive parallax portfolio demo with SVG character editor and shareable QR link."
        />
      </Head>
      <main className="min-h-screen overflow-x-hidden">
        ...
        >
          ...
          >
            <h2 className="text-xl font-semibold">Share and Call‑to‑Action</h2>
